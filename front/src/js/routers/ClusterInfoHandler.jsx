...
var ClusterInfo = require('../components/ClusterInfo');
var Utils = require('../utils/Utils');

var ClusterInfoHandler = React.createClass({
    ...
    render: function() {
        ...
        var key = 'cluster-info-' + this.getParams().clusterName;
        ...
        if (cluster) {
            ...
            return this.renderNoCluster(this.getParams().clusterName, key);
        }
    },
...
module.exports = ClusterInfoHandler;
